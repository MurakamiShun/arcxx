...
.. cpp:struct:: template<typename Derived>\
    ...
    :code:`arcxx::model` is designed using
    ...
    .. cpp:struct:: schema
        ...
        .. cpp:function::  to_sql()
            ...
            .. code-block:: cpp
                ...
                static arcxx::string to_sql(bool create_if_not_exist = false);
    ...
    .. cpp:function:: order_by()
      ...
      .. code-block:: cpp
        ...
        template<is_attribute Attr>
        static auto order_by(const arcxx::order = arcxx::order::asc) -> query_relation<std::vector<Derived>, std::tuple<>>;
