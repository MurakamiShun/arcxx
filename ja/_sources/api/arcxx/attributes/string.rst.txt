...
.. cpp:struct:: template<typename Model, typename Attribute> \
    ...
    .. list-table:: Member variables
        ...
        * - :cpp:var:`data`
          - :code:`std::optional<arcxx::string>`
    ...
    .. list-table:: Member types
        ...
        * - :cpp:type:`value_type`
          - :code:`arcxx::string`
        * - :cpp:type:`constraint`
          - :code:`std::function<bool(const std::optional<arcxx::string>&)>`
    ...
    .. cpp:function:: string()
        ...
        .. code-block:: cpp
            ...
            constexpr string();
            constexpr string(const std::optional<arcxx::string>&);
            constexpr string(const std::optional<arcxx::string>&&);
            constexpr string(std::nullopt_t);

            constexpr string(const arcxx::string&);
            constexpr string(const arcxx::string&&);
    ...
    .. cpp:function:: operator=()
        ...
        .. code-block:: cpp
            ...
            Attribute& operator=(const std::optional<arcxx::string>&);
            Attribute& operator=(const std::optional<arcxx::string>&&);
            Attribute& operator=(std::nullopt_t);

            Attribute& operator=(const arcxx::string&);
            Attribute& operator=(const arcxx::string&&);
    ...
    .. cpp:function:: value()
        ...
        .. code-block:: cpp
            ...
            [[nodiscard]] arcxx::string& value() &;
            [[nodiscard]] const arcxx::string& value() const&;
            [[nodiscard]] arcxx::string&& value() &&;
    ...
    .. cpp:function:: between()
        ...
        .. code-block:: cpp
            ...
            query_condition between(std::convertible_to<arcxx::string> arg1, std::convertible_to<arcxx::string> arg2);
    ...
    .. cpp:function:: like()
        ...
        .. code-block:: cpp
            ...
            query_condition like(std::convertible_to<arcxx::string> arg);
