...
namespace arcxx{
    ...
    using string_view = std::basic_string_view<typename arcxx::string::value_type>;
    ...
    [[nodiscard]] inline arcxx::string sanitize(const arcxx::string& src) {
        arcxx::string result;
    ...
    requires requires (Strings... strs){
        (std::convertible_to<Strings, arcxx::string_view> && ...);
    }
    [[nodiscard]] arcxx::string concat_strings(Strings&&... strings) {
        const std::array<arcxx::string_view, sizeof...(Strings)> str_views = { static_cast<arcxx::string_view>(strings)... };
        arcxx::string buff;
    ...
    using string_literal = basic_string_literal<typename arcxx::string::value_type, N>;

    template<std::size_t N>
    using built_in_string_literal = const typename arcxx::string::value_type (&)[N];
